const openFooterModal = document.querySelector('.footer__right-item:last-of-type');
const footerBar = document.querySelector('.footer__bar');
const footerModal = document.querySelector('.footer__modal');
const body = document.querySelector('body');
const closeFooterModal = document.querySelector('.footer__modal-contenido', '::after');
